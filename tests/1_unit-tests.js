...
suite('UnitTests', () => {
     suite("solver tests",function(){
       ...
       test("Logic handles a puzzle string with invalid characters (not 1-9 or .)",function(done){
         let invalidPuzzle="1.5..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16.c..926914.37.";
         assert.equal(solver.solve(invalidPuzzle),false);
         done();
       })
       test("Logic handles a puzzle string that is not 81 characters in length",function(done){
         let invalidPuzzle="1.5..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16.17..926914.37.";
         assert.equal(solver.solve(invalidPuzzle),false);
         done();
       })
